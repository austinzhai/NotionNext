...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '德国精益方法论结合先进数字化工具，快速实现准时交付，降低库存', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://inv.originflow.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '降低库存, 精益,库存优化,降低交期,准时交付,APS', // 网站关键词 英文逗号隔开
